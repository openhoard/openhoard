...
| [`summarize/`](summarize/) | File-card schema, summary prompt, output schema and filter, prompt-injection detection          |
| [`models/`](models/)       | Model providers (Ollama, OpenAI-compatible, Anthropic, stub), routing by exposure, token budget |
